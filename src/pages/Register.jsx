            ...
            >
                <div className="max-w-md w-full mx-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button 
                            type="submit"
                            className="w-full bg-linear-to-r from-[#67C090] to-[#26667F] text-white font-bold py-3.5 px-4 rounded-xl hover:bg-[#1a4a5c] transform transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5 mt-2"
                        >
                            Registrarse
                        </button>
                    </form>
